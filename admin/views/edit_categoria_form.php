                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" id="f-lanzamiento" name="f-lanzamiento" placeholder="Nombre de la categoría" value="<?= $categoria->getFecha_lanzamiento()?>"required>
