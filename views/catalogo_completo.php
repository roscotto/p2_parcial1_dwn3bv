<?PHP
$catalogo = (new Producto())->catalogo_completo();

$nombre_categoria = (new Categoria())->getNombre();
$descripcion_categoria = (new Categoria())->getDescripcion();
